  ...
  private void iniciarComponentes() {
    ...
    panel.setBorder(
        new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, new Color(255, 255, 255), new Color(160, 160, 160)),
            "Datos del articulo", TitledBorder.CENTER, TitledBorder.TOP, null, new Color(255, 0, 0)));
    ...
    panel_1.setBorder(
        new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, new Color(255, 255, 255), new Color(160, 160, 160)),
            "Precio de venta", TitledBorder.CENTER, TitledBorder.TOP, null, new Color(0, 0, 0)));
